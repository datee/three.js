...
class Matrix4
{
    ...
    public var isMatrix4(default, never):Bool = true;
    ...
    public function setPositionFromVector(v:Vector3):Matrix4
    {
    ...
    public function invert():Matrix4
    {
        ...
        var n11 = te[0], n21 = te[1], n31 = te[2],  n41 = te[3];
        var n12 = te[4], n22 = te[5], n32 = te[6],  n42 = te[7];
        var n13 = te[8], n23 = te[9], n33 = te[10], n43 = te[11];
        var n14 = te[12], n24 = te[13], n34 = te[14], n44 = te[15];
    ...
    public function makePerspective(left:Float, right:Float, top:Float, bottom:Float, near:Float, far:Float):Matrix4
    {
        var te = elements;
    ...
    public function equals(m:Matrix4):Bool
    {
        var te = elements;
        var me = m.elements;
    ...
    private static var _zero:Vector3 = new Vector3(0, 0, 0);
    private static var _one:Vector3 = new Vector3(1, 1, 1);
    private static var _x:Vector3 = new Vector3();
    private static var _y:Vector3 = new Vector3();
    private static var _z:Vector3 = new Vector3();
}
