 ...
 * Unlike the Lambertian model used in MeshLambertMaterial, this material can simulate
...
class MeshPhongMaterial extends Material
{
    ...
    public var isMeshPhongMaterial(default, never):Bool = true;
    ...
    public function copyMeshPhong(source:MeshPhongMaterial):MeshPhongMaterial
    {
        super.copy(source);
    ...
    {
        return new MeshPhongMaterial().copyMeshPhong(this);
    }
}
